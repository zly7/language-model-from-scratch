...
def main():
    ...
    config = ReformerConfig(vocab_size=tokenizer.vocab_size, num_attention_heads=8,attention_head_size=128, 
            ...
            attn_layers=['lsh',],
            feed_forward_size=1024*4,axial_pos_shape=[32,64],axial_pos_embds_dim=[256,512],hidden_size=768,num_buckets=32)
    ...
    args = TrainingArgumentsSelf(
        output_dir=f"hug_re_pretrain/new_data_{date_string}/",
